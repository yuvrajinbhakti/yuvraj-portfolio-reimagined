...
const footerSocials = [
  ...
  // The resume used to hang off a "Connect with Me" card in the middle of the
  // About section — one of four places the page stopped to ask for contact.
  // That card went, and with it the only visible link to the CV: ⌘K still had
  // it, but a resume nobody can find without knowing the shortcut exists is a
  // resume that isn't there. It belongs beside the other ways to reach him.
  {
    name: 'Resume',
    href: RESUME_URL,
    icon: (
